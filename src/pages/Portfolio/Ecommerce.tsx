...
import { PORTFOLIO_ECOMMERCE_PORTFOLIO, CONTACT_FORM } from "../../graphql/Queries";
...
const Ecommerce: React.FunctionComponent = () => {
	return (
		<React.Fragment>
			<React.Suspense fallback={<ProjectsCardLoadingSkeleton />}>
				<PortfolioCard query={PORTFOLIO_ECOMMERCE_PORTFOLIO} />
			</React.Suspense>
