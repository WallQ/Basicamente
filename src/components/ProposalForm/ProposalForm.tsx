                        ...
                        <form id={`${id}-form`} onSubmit={handleSubmit(onSubmit)} className="flex w-full flex-col flex-wrap gap-y-4 xl:w-2/3">
                            <div className="flex flex-col gap-x-4 gap-y-4 lg:flex-row">
                                <div className="flex flex-1 flex-col">
                                    <label htmlFor={`${id}-firstName`} className="block text-base font-normal text-primary">
                                ...
                                <div className="flex flex-1 flex-col">
                                    <label htmlFor={`${id}-lastName`} className="block text-base font-normal text-primary">
                            ...
                            <div className="flex flex-col gap-x-4 gap-y-4 lg:flex-row">
                                <div className="flex flex-1 flex-col">
                                    <label htmlFor={`${id}-email`} className="block text-base font-normal text-primary">
                                ...
                                <div className="flex flex-1 flex-col">
                                    <label htmlFor={`${id}-telephone`} className="block text-base font-normal text-primary">
                            ...
                            <div className="flex flex-col">
                                <label htmlFor={`${id}-company`} className="block text-base font-normal text-primary">
                            ...
                            <div className="flex flex-col gap-x-4 gap-y-4 lg:flex-row">
                                <div className="flex flex-1 flex-col">
                                    <h6 className="text-base font-normal text-primary mb-1">{data.proposalForm.servicesTitle}</h6>
                                    {data.proposalForm.servicesCollection?.items.map((service: any, index: number) => (
                                        <React.Fragment key={`${id}-Service-${index}`}>
                                            <div className="flex flex-1 flex-row items-center gap-x-2">
                                                ...
                                                />
                                                <label htmlFor={`${id}-service-${index}`} className="block text-sm font-light text-gray-900">
                                                    {service.title}
                                                </label>
                                            </div>
                                        </React.Fragment>
                                ...
                                <div className="flex flex-1 flex-col">
                                    <h6 className="text-base font-normal text-primary mb-1">{data.proposalForm.budgetsTitle}</h6>
                                    {data.proposalForm.budgetsCollection?.items.map((budget: any, index: number) => (
                                        <React.Fragment key={`${id}-Budget-${index}`}>
                                            <div className="flex flex-1 flex-row items-center gap-x-2">
                                                <input 
                                                    type="radio"
                                                    id={`${id}-budget-${index}`}
                                                    ...
                                                    className="focus:border-primary focus:ring-primary h-4 w-4 text-primary border-gray-300 rounded-sm"
                                                />
                                                <label htmlFor={`${id}-budget-${index}`} className="block text-sm font-light text-gray-900">
                                                    {budget.title}
                                                </label>
                                            </div>
                                        </React.Fragment>
                                ...
                                <div className="flex flex-1 flex-col">
                                    <h6 className="text-base font-normal text-primary mb-1">{data.proposalForm.timesTitle}</h6>
                                    {data.proposalForm.timesCollection?.items.map((time: any, index: number) => (
                                        <React.Fragment key={`${id}-Time-${index}`}>
                                            <div className="flex flex-1 flex-row items-center gap-x-2">
                                                <input 
                                                    type="radio"
                                                    id={`${id}-time-${index}`}
                                                    ...
                                                    className="focus:border-primary focus:ring-primary h-4 w-4 text-primary border-gray-300 rounded-sm"
                                                />
                                                <label htmlFor={`${id}-time-${index}`} className="block text-sm font-light text-gray-900">
                                                    {time.title}
                                                </label>
                                            </div>
                                        </React.Fragment>
                            ...
                            <div className="flex flex-col">
                                <label htmlFor={`${id}-message`} className="block text-base font-normal text-primary">
                            ...
                            <React.Suspense fallback={<p className="text-sm font-light text-primary">Loading reCAPTCHA...</p>}>
                                <ReCAPTCHA
                                    ref={recaptchaRef}
                            ...
                            <button type="submit" className={`mx-auto inline-flex h-12 w-full items-center justify-center rounded-none border border-transparent bg-primary px-4 text-base font-normal text-white shadow-sm hover:opacity-80 lg:w-fit ${verified ? 'cursor-pointer' : 'cursor-not-allowed opacity-80'} ${isValid ? 'cursor-pointer' : 'cursor-not-allowed opacity-80'}`} disabled={!verified && !isValid}>
