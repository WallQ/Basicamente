				...
				{({ open }: { open: boolean }) => (
					<React.Fragment>
						<Disclosure.Button className="group inline-flex items-center justify-center gap-x-1 rounded-md align-middle text-base font-medium text-gray-900 hover:text-gray-600 focus:outline-none">
							...
							<ChevronDownIcon
								className={`${open ? "rotate-180 transform duration-200" : "duration-200"} h-6 w-6 text-gray-900 group-hover:text-gray-600`} aria-hidden="true" />
						</Disclosure.Button>
						<Disclosure.Panel className="flex w-full flex-1 flex-grow flex-col items-center justify-center border-t border-b border-t-gray-500 border-b-gray-500">
