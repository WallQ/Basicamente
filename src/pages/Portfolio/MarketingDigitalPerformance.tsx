...
import { PORTFOLIO_MARKETINGDIGITALPERFORMANCEPAGE_PORTFOLIO, CONTACT_FORM } from "../../graphql/Queries";
	...
	return (
		<React.Fragment>
			<React.Suspense fallback={<ProjectsCardLoadingSkeleton />}>
				<PortfolioCard query={PORTFOLIO_MARKETINGDIGITALPERFORMANCEPAGE_PORTFOLIO} />
			</React.Suspense>
