	...
	return !mobile ? (
				...
				{({ open }: { open: boolean }) => (
					<React.Fragment>
						<Popover.Button className="group inline-flex items-center gap-x-1 rounded-md text-base font-medium text-gray-900 hover:text-gray-600 focus:outline-none">
							<GlobeAltIcon
								className="h-6 w-6 text-gray-900 group-hover:text-gray-600"
								aria-hidden="true"
							/>
							<span>
		...
		<React.Fragment>
			<Disclosure>
				{({ open }: { open: boolean }) => (
					<React.Fragment>
						<Disclosure.Button className="group inline-flex items-center justify-center gap-x-1 rounded-md align-middle text-base font-medium text-gray-900 hover:text-gray-600 focus:outline-none">
							<GlobeAltIcon
								className="h-6 w-6 text-gray-900 group-hover:text-gray-600"
								aria-hidden="true"
							/>
						...
						<Disclosure.Panel className="flex w-full flex-col items-center justify-center border-t border-b border-t-gray-500 border-b-gray-500">
							<Disclosure.Button
								onClick={() => handleClick("pt-PT")}
								className="min-w-full text-left">
								<span className="block px-8 py-2 text-center text-base font-medium text-gray-600 hover:bg-primary hover:text-white">
									Português
								</span>
							</Disclosure.Button>
							<Disclosure.Button
